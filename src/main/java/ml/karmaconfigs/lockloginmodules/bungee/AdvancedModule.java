...
public abstract class AdvancedModule extends Module {
    ...
    public final @NotNull String name() {
        ...
        try {
            ...
            JarFile jar = new JarFile(new File(LockLoginBungee.plugin.getDataFolder() + File.separator + "modules", flName));
            ...
            if (moduleEntry != null) {
                ...
                if (module_yml != null) {
                    ...
                    name = values.getOrDefault("name", "version not set in module.yml").toString();
                    module_yml.close();
                }
            }
