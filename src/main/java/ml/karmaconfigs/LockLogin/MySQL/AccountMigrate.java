...
public final class AccountMigrate {
    ...
    public AccountMigrate(Utils sqlAccount, Migrate migration, Platform platform) {
        ...
        ml.karmaconfigs.LockLogin.Spigot.Utils.Files.FileManager spigotManager;
        ml.karmaconfigs.LockLogin.BungeeCord.Utils.Files.FileManager bungeeManager;
        String UUID;
        String player = "";
        String password = "";
        String pin = "";
        ...
        switch (migration) {
            case MySQL:
                switch (platform) {
                    case BUNGEE:
                        ...
                        bungeeManager = new ml.karmaconfigs.LockLogin.BungeeCord.Utils.Files.FileManager(UUID + ".yml", "playerdata");
                    ...
                    case SPIGOT:
                        UUID = Objects.requireNonNull(sqlAccount.getUUID()).toString().replace("-", "");
                        spigotManager = new ml.karmaconfigs.LockLogin.Spigot.Utils.Files.FileManager(UUID + ".yml", "playerdata");
            ...
            case YAML:
                ...
                switch (platform) {
                    case BUNGEE:
                        bungeeManager = new ml.karmaconfigs.LockLogin.BungeeCord.Utils.Files.FileManager(UUIDForFile + ".yml", "playerdata");
                        ...
                        break;
                    case SPIGOT:
                        spigotManager = new ml.karmaconfigs.LockLogin.Spigot.Utils.Files.FileManager(UUIDForFile + ".yml", "playerdata");
